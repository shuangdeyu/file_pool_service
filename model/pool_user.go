...
type PoolUser struct {
	...
	IsManager  string `xorm:"enum('Y','N') NOT NULL DEFAULT 'N'" json:"is_manager"`
...
var DefaultPoolUser = &PoolUser{}

/**
 * 执行原生sql查询，返回string类型的map
 */
func (m *PoolUser) Query(args ...interface{}) ([]map[string]string, error) {
	// 基础sql语句
	sql := ""
 ...
 * 执行原生sql，返回定义的结构体类型
 */
func (m *PoolUser) QueryStructure(args ...interface{}) ([]PoolUser, error) {
	// 基础sql语句
	sql := ""
	switch val := args[0].(type) {
	case string:
 ...
 */
func (m *PoolUser) QueryByMap(args ...interface{}) ([]map[string]string, error) {
 ...
 */
func (m *PoolUser) QueryStructureByMap(args ...interface{}) ([]PoolUser, error) {
	result := []PoolUser{}
 ...
 * 获取count
 */
func (m *PoolUser) Count() (int64, error) {
 ...
 * 删除，通过参数构造sql
 */
func (m *PoolUser) Delete(args Arr) error {
 ...
 * 删除，绑定结构体
 */
func (m *PoolUser) DeleteByStructure(id int) error {
 ...
 * 更新，通过参数构造sql
 */
func (m *PoolUser) Update(set, args Arr) error {
 ...
 * 更新，绑定结构体
 */
func (m *PoolUser) UpdateByStructure(args *PoolUser) error {
